...
map.getView().fit([-1796226.926584, 1567439.545302, -1750463.936314, 1594159.007163], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">POAS Latmingué1</h2>';
        return titleElement;
    })(),
